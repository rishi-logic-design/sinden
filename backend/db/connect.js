...
Database.StatusHistory = require("../models/StatusHistory")(sequelize, DataTypes);
Database.AuditLog = require("../models/AuditLog")(sequelize, DataTypes);
Database.ReportHistory = require("../models/ReportHistory")(sequelize, DataTypes);
...
Database.Signature.belongsTo(Database.User, { foreignKey: "signed_by_user_id" });
